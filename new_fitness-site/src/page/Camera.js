...
function Camera({ props, updateStateData, results_Data }) {
    ...
    const onResults = (results) => {
        ...
        if (results.poseLandmarks) {
            ...
            drawLandmarks(canvasCtx, [results.poseLandmarks[landmark1], results.poseLandmarks[landmark2], results.poseLandmarks[landmark3]], { color: 'gray', lineWidth: 1, fillColor: 'gray', radius: '2' });
